...
const WeatherDetails = ({ data }: WeatherDetailsProps) => {
  return (
    <>
      <div className="p-12">
        <h1 className="mb-4 text-2xl text-sky-200 border-b-2 border-b-sky-100 w-1/3">
          Weather Details
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          <div className="bg-sky-100/50 flex p-4 items-center justify-between gap-6 rounded-xl">
          ...
          <div className="bg-sky-100/50 flex p-4 items-center justify-between gap-6 rounded-xl">
            <div className="text-2xl">
              <h3 className="text-sky-900">Humidity</h3>
